...
for run in {1..5};
do
$1 exec:java -pl Client -Dexec.mainClass=com.compsci677.lab1.part2.CustomerClient -DlookupOnly -DloadTestingOutputFile="loadTestResult/loadRes$run" -Dexec.args="$2 $3 1000" &
done
wait
